...
@Repository
public interface Invations_response extends JpaRepository<invitation_respons_DBO, InvitationId> {
    // Find invitation responses where username2 is the receiver
    java.util.List<invitation_respons_DBO> findByUsername2(String username2);
    // Find invitation responses where username1 is the sender
    java.util.List<invitation_respons_DBO> findByUsername1(String username1);
